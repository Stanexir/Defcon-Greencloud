...
import me.mochibit.defcon.items.variants.BaseItem
import me.mochibit.defcon.items.variants.GasMaskItem
import me.mochibit.defcon.items.variants.GeigerCounterItem
import me.mochibit.defcon.items.variants.RadiationHealerItem
import me.mochibit.defcon.items.variants.StructureAssemblerItem


enum class ItemBehaviour(
    val itemFactory: (baseProperties: BaseProperties, additionalData: Map<String, Any>) -> BaseItem
) {
    ...
    RADIATION_HEALER({ baseProperties, additionalData ->
        ...
        val data = RadiationHealerItem.RadiationHealerData(baseProperties, healAmount, durationSeconds)
